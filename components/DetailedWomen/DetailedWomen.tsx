...
function DetailedWomen() {
    const { womenId } = useParams<{ womenId?: string }>();
    ...
    const fetchItemDetails = async () => {
        try {
            ...
            const selectedItem = response.data.find(item => item.id.toString() === womenId);
